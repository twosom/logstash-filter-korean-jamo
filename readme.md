# Logstash Korean Jamo Filter [![Build Status](https://app.travis-ci.com/twosom/logstash-filter-korean-jamo.svg?branch=master)](https://app.travis-ci.com/twosom/logstash-filter-korean-jamo)
